...
function initPano(){//TODO
  ...
  window.addEventListener('message', function(messageEvent) {
    modelCode = messageEvent.data;
    console.log('收到 vue 的数据:',modelCode)
    embedpano({
      swf: "tour.swf",
      xml: "http://uniq.fawjiefang.com.cn/unique/api/hot_recommend/vr_xml?modelCode="+modelCode,
      // xml: "http://sy.aerozhonghuan.com:81/test/unique/api/hot_recommend/vr_xml?modelCode="+modelCode,
      // xml: "http://sy.aerozhonghuan.com:81/dev/unique/api/hot_recommend/vr_xml?modelCode="+modelCode,
      target: "pano",
      html5:'prefer',
      //flash:'only',
      wmode:'opaque-flash',
